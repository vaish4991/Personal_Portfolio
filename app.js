    ...
    initProjectModals() {
        ...
        const projectData = {
            1: {
                ...
                description: "A modern, responsive portfolio website built with HTML, CSS, and JavaScript featuring interactive elements and professional design. This project showcases my web development skills and serves as a digital resume highlighting my projects, certifications, and contact information.",
                techStack: ["HTML5", "CSS3", "JavaScript", "Responsive Design"],
                details: "Features include smooth scrolling navigation, typing animations, theme toggle, contact form validation, and responsive design. The website is optimized for performance and accessibility."
            },
            2: {
